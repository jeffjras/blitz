...
import br.ufpa.eas.tap.config.audit.AuditEventConverter;
import br.ufpa.eas.tap.domain.PersistentAuditEvent;
...
import static br.ufpa.eas.tap.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
