...
import br.ufpa.eas.tap.repository.FiscalizacaoRepository;
...
import static br.ufpa.eas.tap.web.rest.TestUtil.createFormattingConversionService;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import br.ufpa.eas.tap.domain.enumeration.SituacaoFiscalizacao;
/**
...
public class FiscalizacaoResourceIntTest {
    ...
    public void createFiscalizacao() throws Exception {
        ...
        assertThat(testFiscalizacao.getNome()).isEqualTo(DEFAULT_NOME);
    ...
    public void updateFiscalizacao() throws Exception {
        ...
        Fiscalizacao testFiscalizacao = fiscalizacaoList.get(fiscalizacaoList.size() - 1);
        assertThat(testFiscalizacao.getNome()).isEqualTo(UPDATED_NOME);
