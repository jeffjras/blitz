...
import br.ufpa.eas.tap.repository.OperacaoRepository;
...
import br.ufpa.eas.tap.domain.enumeration.StatusOperacao;
/**
...
public class OperacaoResourceIntTest {
    ...
    public void createOperacao() throws Exception {
        ...
        assertThat(testOperacao.getNome()).isEqualTo(DEFAULT_NOME);
    ...
    public void updateOperacao() throws Exception {
        ...
        Operacao testOperacao = operacaoList.get(operacaoList.size() - 1);
        assertThat(testOperacao.getNome()).isEqualTo(UPDATED_NOME);
